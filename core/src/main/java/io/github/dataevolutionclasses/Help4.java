...
public class Help4 extends ScreenAdapter {
    // Window vars
    private OrthographicCamera camera;              // Camera
    private FitViewport viewport;                   // Viewport
    private SpriteBatch spriteBatch;
    private Sprite backSpr, prevSpr, nextSpr, HelpPage4;       // Sprites for background and help elements
    ...
    public void show() {
        ...
        HelpPage4.setSize(600, 600); // Help page fills the viewport
